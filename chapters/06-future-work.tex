...
\begin{enumerate}[label=(\arabic*)]
    \item Build a lexicon of lexical type probabilities from an annotated corpus.
...
This thesis has aimed to do one thing carefully rather than many things incompletely: to develop
the central idea into a coherent formal proposal. The result is a
