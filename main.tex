...
from the formal domain instead of being given ad hoc values, lexical types not attested for a
word receive probability $0$, and the residual clauses are defined so as to avoid division by
zero. The revised formalisation also separates direct lexical assignment from the recursive
...
\input{chapters/03-formalisation}
\input{chapters/04-worked-example}
